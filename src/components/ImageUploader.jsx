...
const Home = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      title: "Ubicación",
      description:
        "Encuéntranos en el corazón de La Paz y disfruta de nuestro ambiente acogedor.",
    ...
    },
    {
      ...
      title: "Videos",
      description:
        "Mira cómo preparamos nuestras pizzas y conoce nuestro proceso artesanal.",
    ...
    },
    {
      ...
      title: "Galería",
      description:
        "Explora nuestra galería de imágenes y déjate tentar por nuestros platos.",
    ...
    },
    {
      ...
      title: "Podcasts",
      description:
        "Escucha historias sobre gastronomía y conoce los secretos de la cocina.",
    ...
    },
    {
      ...
      title: "Noticias",
      description:
        "Mantente al día con nuestras últimas novedades y promociones especiales.",
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <section className="relative bg-gradient-to-r from-primary-600 to-primary-800 text-white py-20 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              Las mejores pizzas artesanales de La Paz, hechas con ingredientes
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                ...
                >
                  <div
                    className={`inline-flex p-3 rounded-full bg-gray-100 dark:bg-gray-700 mb-4 ${feature.color}`}
                  >
        ...
        <section className="py-16 bg-primary-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Haz tu pedido ahora y disfruta de nuestras deliciosas pizzas en la
